...
The FT4222 USB spectrum scope reader requires `libft4222`, which is not available as a distro package. See [FT-710 Spectrum Scope Setup](Spectrum-Scope-FT-710) for manual installation instructions.
